          ...
          <div className="text-center max-w-md">
            ...
            <div className="mt-12 p-6 bg-slate-900/50 rounded-lg border border-slate-800">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                <Link to="/learning-path/devops" className="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm hover:bg-blue-500/30 transition-colors">
                  DevOps
                </Link>
                <Link to="/learning-path/python" className="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm hover:bg-green-500/30 transition-colors">
                  Python
                </Link>
                <Link to="/learning-path/web-development" className="px-3 py-1 bg-purple-500/20 text-purple-400 rounded-full text-sm hover:bg-purple-500/30 transition-colors">
                  Web Dev
                </Link>
                <Link to="/learning-path/cybersecurity" className="px-3 py-1 bg-red-500/20 text-red-400 rounded-full text-sm hover:bg-red-500/30 transition-colors">
                  Security
                </Link>
              </div>
            </div>

...
export const webCourses: Course[] = [
  {
    ...
    category: 'Web',
    topics: ['Components', 'JSX', 'State Management', 'Props', 'Event Handling'],
  ...
  },
  {
    ...
    category: 'Web',
    topics: ['React Hooks', 'Context API', 'React Router', 'Form Handling', 'Performance'],
  ...
  },
  {
    ...
    category: 'Web',
    topics: ['Advanced Patterns', 'Testing Strategies', 'State Management', 'Scalable Architecture'],

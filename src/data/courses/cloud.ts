...
export const cloudCourses: Course[] = [
  {
    ...
    category: 'Cloud',
    topics: ['AWS Basics', 'Azure Fundamentals', 'Virtual Machines', 'Cloud Storage', 'Networking'],
  ...
  },
  {
    ...
    category: 'Cloud',
    topics: ['Managed Databases', 'Advanced Networking', 'Cloud Security', 'Infrastructure Automation'],
  ...
  },
  {
    ...
    category: 'Cloud',
    topics: ['Enterprise Architecture', 'Multi-cloud Strategy', 'Cost Optimization', 'Governance Frameworks'],
